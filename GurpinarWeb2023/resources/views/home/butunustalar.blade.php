                ...
                <div class="navbar-nav mr-auto py-0">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu rounded-0 m-0">
                            ...
                            <a href="{{ route('tumustalar') }}" target="_blank" class="dropdown-item active">Ustalar</a>
    ...
    <div class="container-fluid">
        <div class="container">
            <nav class="breadcrumb bg-transparent m-0 p-0">
                ...
                <span class="breadcrumb-item active">Ustalar</span>
            </nav>
        </div>
    </div>
    <!-- Breadcrumb End -->
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="d-flex align-items-center justify-content-between bg-light py-2 px-4 mb-3">
                                <h3 class="m-0">Bütün Ustalar</h3>
                                <a class="text-secondary font-weight-medium text-decoration-none" href=""></a>
                            </div>
                        </div>

                        @foreach ($tumustalar as $tumustalar)
                            <div class="col-lg-66">
                                <div class="position-relative mb-3">
                                    <a href="{{ route('ustalarslug', $tumustalar->slug) }}">
                                        <img class="img-fluid w-100"
                                            src="ustagorseller/{{ $tumustalar->usta_gorseli }}"
                                            style="object-fit: cover;">
                                    </a>
                                    <div class="overlay position-relative bg-light">
                                        <div class="mb-2" style="font-size: 14px;">
                                            <a href="{{ route('ustalarslug', $tumustalar->slug) }}">Usta ismi: <span
                                                    style="color: black">{{ $tumustalar->usta_ismi }}</span></a>
                                        </div>
                                        <a class="h4"
                                            href="{{ route('ustalarslug', $tumustalar->slug) }}">{{ $tumustalar->ustanin_yaptigi_is }}</a>
                                        <p class="m-0">{{ Str::Limit($tumustalar->usta_aciklamasi) }}</p>
                                    </div>
                                </div>
                            </div>
                        @endforeach

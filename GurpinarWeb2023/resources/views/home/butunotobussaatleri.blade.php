                ...
                <div class="navbar-nav mr-auto py-0">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu rounded-0 m-0">
                            ...
                            <a href="{{ route('tumotobus') }}" target="_blank" class="dropdown-item active">Otobüs
                                Saatleri</a>
    ...
    <div class="container-fluid">
        <div class="container">
            <nav class="breadcrumb bg-transparent m-0 p-0">
                ...
                <span class="breadcrumb-item active">Otobüs Saatleri</span>
            </nav>
        </div>
    </div>
    <!-- Breadcrumb End -->
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="d-flex align-items-center justify-content-between bg-light py-2 px-4 mb-3">
                                <h3 class="m-0">Gürpınar Otobüs Saatleri</h3>
                                <a class="text-secondary font-weight-medium text-decoration-none" href=""></a>
                            </div>
                        </div>

                        @foreach ($tumotobussaatleri as $tumotobussaatleri)
                            <div class="saatlerisirala"
                                style="position: relative; width: 50%; padding-right: 5px; padding-left: 5px;">
                                <a href="asdsa">
                                    <div>
                                        ...
                                        <div
                                            style="background: rgb(233, 255, 67); align-items: center; padding: 10px; text-align: center">

                                            <div class="mb-2" style="font-size: 14px;">

                                                <a class="h4"
                                                    href="{{ route('otobusslugger', $tumotobussaatleri->slug) }}">{{ $tumotobussaatleri->otobus_baslik }}</a>
                                        ...
                                        <a target="_blank"
                                            href="{{ route('otobusslugger', $tumotobussaatleri->slug) }}">

                                            <img class="img-fluid w-100"
                                                src="otobussaatleri/{{ $tumotobussaatleri->otobus_gorsel }}"

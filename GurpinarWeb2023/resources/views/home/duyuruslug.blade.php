    ...
    <div class="container-fluid">
        <div class="container">
            <nav class="breadcrumb bg-transparent m-0 p-0">
                ...
                <a class="breadcrumb-item" style="color: black">Duyurular</a>
    ...
    <div class="container-fluid py-3">
        <div class="container">
            <div class="row">
                <div class="col-lg-8">
                    <!-- News Detail Start -->
                    @foreach ($duyurubilgiler as $duyurubilgiler)
                        <div class="position-relative mb-3">
                            <img class="img-fluid w-100" src="duyurugorseller/{{ $duyurubilgiler->duyuru_gorsel }}"
                            ...
                            <div class="overlay position-relative bg-light">
                                ...
                                <div class="mb-3">
                                    ...
                                    <a href="">{{ $duyurubilgiler->duyuru_yazar }}</a>
                                    <span class="px-1">/</span>
                                    <span>{{ $duyurubilgiler->duyuru_tarih }}</span>
                                </div>
                                ...
                                <div>
                                    <h3 class="mb-3">{{ $duyurubilgiler->duyuru_tarih }}</h3>

                                    <p>{{ $duyurubilgiler->duyuru_aciklama }}</p>

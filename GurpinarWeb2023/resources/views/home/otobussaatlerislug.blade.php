    ...
    <div class="container-fluid">
        <div class="container">
            <nav class="breadcrumb bg-transparent m-0 p-0">
                ...
                <a class="breadcrumb-item" href={{ route('tumotobus') }}>Otobus Saatleri</a>
                @foreach ($otobusbilgiler as $otobusbaslik)
                    <a class="breadcrumb-item">{{ $otobusbaslik->otobus_baslik }}</a>
                @endforeach
    ...
    <div class="container-fluid py-3">
        <div class="container">
            <div class="row">
                <div class="col-lg-8">
                    <!-- News Detail Start -->
                    @foreach ($otobusbilgiler as $otobusbilgiler)
                        <div class="position-relative mb-3">

                            <div class="baslikortala position-relative bg-light">
                                <div class="mb-3" style="text-align: center">

                                    <a href=""
                                        style="font-size: 40px; color: rgb(136, 35, 35)"><strong>{{ $otobusbilgiler->otobus_baslik }}</strong></a>

                                </div>
                            </div>
                            <img class="img-fluid w-100" src="otobussaatleri/{{ $otobusbilgiler->otobus_gorsel }}"
                            ...
                            <div class="overlay position-relative bg-light">
                                ...
                                <div>
                                    ...
                                    <p>{{ $otobusbilgiler->otobus_aciklama }}</p>

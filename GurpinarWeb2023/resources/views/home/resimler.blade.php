            ...
            <div class="collapse navbar-collapse justify-content-between px-0 px-lg-3" id="navbarCollapse">
                <div class="navbar-nav mr-auto py-0">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu rounded-0 m-0">
                            <a href="{{ route('resimler') }}" target="_blank"
                                class="dropdown-item active"><b>Resimler</b></a>
                    ...
                    <div class="row mb-3">
                        <div class="col-12">
                            <div class="d-flex align-items-center justify-content-between bg-light py-2 px-4 mb-3">
                                <h3 class="m-0" style="color: red">Resimler</h3>
                                <a class="text-secondary font-weight-medium text-decoration-none" href=""></a>
                            </div>
                        </div>

                        @foreach ($nostaljiresimler as $nostaljiresim)
                            <div class="ucerli">
                                <div class="position-relative mb-3">
                                    <img class="img-fluid w-100" href=""
                                        src="nostaljiresimler/{{ $nostaljiresim->resim_gorseli }}"
                                        style="object-fit: fill; height: 250px; width: 250px;">
                                    <div class="overlay position-relative bg-light">
                                        <div class="mb-2" style="font-size: 14px;">
                                            <a href="">Gönderen</a>
                                            <span class="px-1">|</span>
                                            <span>{{ $nostaljiresim->gonderici_ismi }}</span>
                                            <br>
                                            <a href="">Resim Tarihi: {{ $nostaljiresim->resim_tarihi }}</a>
                                        </div>
                                        <a class="h4" href="">{{ $nostaljiresim->resim_basligi }}</a>
                                        <p class="m-0">{{ $nostaljiresim->resim_aciklamasi }}</p>
                                    </div>
                                </div>
                            </div>
                        @endforeach
                        ...
                        <div style="margin-left:  50%; margin-top: 5%;">
                            ...
                            {{ $nostaljiresimler->onEachSide(1)->links() }}

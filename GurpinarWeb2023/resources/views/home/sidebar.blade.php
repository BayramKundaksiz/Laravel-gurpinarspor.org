                    ...
                    <div class="col-lg-6">
                        <div class="d-flex mb-3">
                            ...
                            <div class="w-100 d-flex flex-column justify-content-center bg-light px-3"
                                ...
                                <a class="h6 m-0" href="">ASDASDLorem ipsum dolor sit amet consec adipis elit</a>
                            </div>
                        </div>
                        <div class="d-flex mb-3">
                    ...
                    <div class="col-lg-6">
                        <div class="position-relative mb-3">
                            ...
                            <div class="overlay position-relative bg-light">
                                ...
                                <p class="m-0">Rebum dolore duo et vero ipsum clita, est ea sed duo diam ipsum, clita
                                    at justo, lorem amet vero eos sed sit...</p>
                            </div>
                        </div>
                        <div class="d-flex mb-3">

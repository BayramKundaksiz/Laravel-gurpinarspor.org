    ...
    <div class="container-fluid">
        <div class="container">
            <nav class="breadcrumb bg-transparent m-0 p-0">
                ...
                <a class="breadcrumb-item">Ustalar</a>
    ...
    <div class="container-fluid py-3">
        <div class="container">
            <div class="row">
                <div class="col-lg-8">
                    <!-- News Detail Start -->
                    @foreach ($ustabilgiler as $ustabilgiler)
                        <div class="position-relative mb-3">
                            <img class="img-fluid w-100" src="ustagorseller/{{ $ustabilgiler->usta_gorseli }}"
                            ...
                            <div class="overlay position-relative bg-light">
                                ...
                                <div class="mb-3">
                                    ...
                                    <span class="px-1" style="wcolor: rgb(213, 50, 50)">Usta İsmi: </span>
                                    <a
                                        style="color: rgb(17, 140, 201); font-size: 25px">{{ $ustabilgiler->usta_ismi }}</a>

                                </div>

                                <div class="mb-3">

                                    <span class="px-1" style="color: rgb(213, 50, 50)">Ustanın Yaptığı İş: </span>
                                    <a
                                        style="color: rgb(17, 140, 201); font-size: 25px">{{ $ustabilgiler->ustanin_yaptigi_is }}</a>

                                    <div class="mb-3">
                                        <span class="px-1" style="color: rgb(213, 50, 50)">Açıklama: </span>
                                        <a
                                            style="color: rgb(17, 140, 201); font-size: 25px">{{ $ustabilgiler->usta_aciklamasi }}</a>
                                    </div>

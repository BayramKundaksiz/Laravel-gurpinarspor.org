        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Gürpınar /</span> Otobüs Saatleri </h4>
              ...
              <div class="row">
                <div class="col-xl">
                  <div class="card mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center">
                      <h5 class="mb-0">Nereden Nereye</h5>
                      <small class="text-muted float-end">Default label</small>
                    </div>
                    <div class="card-body">
                      
                      <form action="{{route('otobus-ekle')}}" method="POST" enctype="multipart/form-data">

                        @csrf
                        
                        <div class="mb-3">
                          <label class="form-label" >Sefer ismi</label>
                          <div class="input-group input-group-merge">
                            <textarea style="width: 100%" name="otobus_baslik" cols="30" rows="5"></textarea>
                          </div>
                        </div>
                ...
                <div class="col-xl">
                  <div class="card mb-4">
                    ...
                    <div class="card-header d-flex justify-content-between align-items-center">
                      <label class="form-label">Otobüs Açıklama</label>
                          <div class="input-group input-group-merge">
                            <textarea style="width: 100%" name="otobus_aciklama" cols="30" rows="5"></textarea>
                          </div>
                    </div>

                    <div class="card-header d-flex justify-content-between align-items-center">
                      <h5 class="mb-0">Otobüs Seferi Görseli</h5>
                    ...
                    <div class="card-body">
                      <form>
                        ...
                        <div class="div_design">
                          ...
                          <input type="file" name="otobus_gorsel" required="">
                        </div>
                        
                        
                        <button style="margin-top: 5%;" class="btn btn-primary">Bilgileri Ekle</button>

        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Gürpınar /</span> Nostalji Videolar </h4>
                ...
                <div class="col-xl">
                  <div class="card mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center">
                      <h5 class="mb-0">Video Bilgileri</h5>
                      <small class="text-muted float-end">Nostalji</small>
                    </div>
                    <div class="card-body">
                      
                      <form action="{{route('videoeklendi')}}" method="POST" enctype="multipart/form-data">

                        @csrf
                        
                        <div class="mb-3">
                          <label class="form-label" >Youtube Embed Linki</label>
                          <div class="input-group input-group-merge">
                            <textarea style="width: 100%" name="youtube_linki" cols="30" rows="2"></textarea>
                          </div>
                        </div>
                        ...
                        <div class="mb-3">
                          ...
                          <div class="input-group input-group-merge">
                            <textarea style="width: 100%" name="baslik" cols="30" rows="3"></textarea>
                          </div>
                        </div> 

                        <button style="margin-top: 5%;" class="btn btn-primary">Videoyu Ekle</button>

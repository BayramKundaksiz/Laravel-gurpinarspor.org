        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Gürpınar /</span> Güncel Yazı Ekle</h4>
              ...
              <div class="row">
                ...
                <div class="col-md-6" style="width: 100%" >
                  <div class="card mb-4">
                    <h5 class="card-header">Lütfen bilgileri doldurunuz</h5>
                    <div class="card-body">

                        <div class="mb-3">
                            <label for="exampleFormControlReadOnlyInput1" class="form-label">Kayan Yazı Açıklaması</label>
                            <textarea class="form-control" name="guncel_metin" cols="30" rows="3"></textarea>
                          </div>

                      <div class="mt-2 mb-3">
                        <button value="Bilgileri Ekle" class="btn btn-primary">Kayan Yazıyı Ekle</button>
                      </div>

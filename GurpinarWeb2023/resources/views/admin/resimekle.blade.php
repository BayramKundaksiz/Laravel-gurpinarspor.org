      ...
      <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            ...
            <!-- Layouts -->
            <li class="menu-item">
              <a href="{{route('videoekle')}}" class="menu-link">
                <i class="menu-icon tf-icons bx bx-layout"></i>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Gürpınar /</span> Nostalji Resimler </h4>
                ...
                <div class="col-xl">
                  <div class="card mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center">
                      <h5 class="mb-0">Resim Bilgileri</h5>
                      <small class="text-muted float-end">Nostalji</small>
                    </div>
                    <div class="card-body">
                      
                      <form action="{{route('resimeklendi')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                          ...
                          <div class="input-group input-group-merge">
                            <textarea style="width: 100%" name="gonderici_ismi" cols="30" rows="2"></textarea>
                          </div>
                        </div>

                        <div class="mb-3">
                          <label class="form-label" >Resim Tarihi</label>
                          <div class="input-group input-group-merge">
                            <input type="date" name="resim_tarihi">
                          </div>
                        </div>
                        ...
                        <div class="mb-3">
                          ...
                          <div class="input-group input-group-merge">
                            <textarea style="width: 100%" name="resim_basligi" cols="30" rows="3"></textarea>
                          </div>
                        </div> 
                ...
                <div class="col-xl">
                  ...
                  <div class="card mb-4">
                    ...
                    <div class="card-header d-flex justify-content-between align-items-center">
                      ...
                      <div class="input-group input-group-merge">
                        <textarea style="width: 100%" name="resim_aciklamasi" cols="30" rows="5"></textarea>
                      </div>
                    </div>
                    
                    <div class="card-header d-flex justify-content-between align-items-center">
                      <h5 class="mb-0">Resim Görseli</h5>
                      <small class="text-muted float-end">Nostalji Fotoğrafı</small>
                    </div>
                    <div class="card-body">
                      <form>
                        ...
                        <div class="div_design">
                          ...
                          <input type="file" name="resim_gorseli" required="">
                        </div>
                        
                        
                        <button style="margin-top: 5%;" class="btn btn-primary">Resmi Ekle</button>

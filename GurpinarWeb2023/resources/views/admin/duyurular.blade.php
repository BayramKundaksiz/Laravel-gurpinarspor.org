      ...
      <div class="layout-container">
        ...
        <div class="layout-page">
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Gürpınar /</span> Üst Kayan Görseller Ekle</h4>
              ...
              <div class="col-xl">
                <div class="card mb-4">
                  ...
                  <div class="card-body">
                    ...
                    <form action="{{route('duyuru-ekle')}}" method="POST" enctype="multipart/form-data">
                      ...
                      <div class="mb-3">
                        ...
                        <div class="input-group input-group-merge">
                          <textarea style="width: 100%" name="duyuru_baslik" cols="30" rows="5"></textarea>
                        </div>
                      </div>

                      <div class="mb-3">
                        <label class="form-label" >Duyuru Yazarı</label>
                        <div class="input-group input-group-merge">
                          <textarea style="width: 100%" name="duyuru_yazar" cols="30" rows="1"></textarea>
                        </div>
                      </div>

                      <div class="mb-3">
                        <label class="form-label" >Duyuru Tarihi</label>
                        <div class="input-group input-group-merge">
                          <input type="date" name="duyuru_tarih">
                        </div>
                      </div>
                ...
                <div class="card mb-4">
                  ...
                  <div class="card-header d-flex justify-content-between align-items-center">
                    <label class="form-label" >Duyuru Açıklama</label>
                        <div class="input-group input-group-merge">
                          <textarea style="width: 100%" name="duyuru_aciklama" cols="30" rows="5"></textarea>
                        </div>
                  </div>
                  ...
                  <div class="card-body">
                      ...
                      <div class="div_design">
                        ...
                        <input type="file" name="duyuru_gorsel" required="">
                      </div>
                      
                      
                      <button style="margin-top: 5%;" class="btn btn-primary">Duyuru Görseli Ekle</button>

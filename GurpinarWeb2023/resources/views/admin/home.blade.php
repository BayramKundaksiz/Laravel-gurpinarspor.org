  ...
  <head>
    ...
    <style>
        ...
        .tablogenislik {
            ...
            width: 100%;
            height: 30px;
            border: 5px solid rgb(11, 125, 169);
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Gürpınar /</span> Gelen Mesajlar</h4>


              @if (count($gelenmesaj) == 0)

                <h1 style="color: red; text-align: center; font-size: 50px; padding-top: 100px;">Gelen Mesaj Yok</h1>
@else
<div class="row">
                <div class="col-md-6">
                  <div class="card mb-4">
                ...
                <form action="{{ route('guncelyazieklendi') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="col-md-6" style="width: 100%" >
                  ...
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <table class="table table-bordered"> <!--Tablomuzu oluşturmak için kullandığımız etiket-->
                            ...
                            @foreach ($gelenmesaj as $gelenmesajlar)
<tr>
                                <td>{{ $gelenmesajlar->id }}</td>
                                <td>{{ $gelenmesajlar->isim }}</td>
                                <td>{{ $gelenmesajlar->eposta }}</td>
                                <td>{{ $gelenmesajlar->konu }}</td>
                                <td>{{ $gelenmesajlar->mesaj }}</td>
                                <td>{{ $gelenmesajlar->telefon }}</td>

                                <td>
                                    <a class="btn btn-danger" onclick="return confirm('{{ $gelenmesajlar->where('id', $gelenmesajlar->id)->select('isim')->get() }} isimli kullanıcıdan gelen mesajı silmek istiyor musunuz ?')" href="{{ route('mesaj_sil', $gelenmesajlar->id) }}">Sil</a>
                                  </td>
                            </tr>
@endforeach

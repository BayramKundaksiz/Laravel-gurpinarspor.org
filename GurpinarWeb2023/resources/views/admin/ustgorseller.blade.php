                ...
                <div class="col-xl">
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                      ...
                      <form action="{{route('ust-gorsel-ekle')}}" method="POST" enctype="multipart/form-data">

                        @csrf
                        
                        <div class="mb-3">
                          <label class="form-label" >Üst Görsel Başlığı</label>
                          <div class="input-group input-group-merge">
                            <textarea style="width: 100%" name="ust_baslik" cols="30" rows="5"></textarea>
                          </div>
                        </div>
                    </div>
                  </div>
                    ...
                    <div class="card-body">
                      <form>
                        ...
                        <div class="div_design">
                          ...
                          <input type="file" name="ust_gorsel" required="">
                        </div>
                        
                        
                        <button style="margin-top: 5%;" class="btn btn-primary">Üst Görsel Ekle</button>

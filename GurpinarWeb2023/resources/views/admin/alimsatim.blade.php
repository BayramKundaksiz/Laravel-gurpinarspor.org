        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Gürpınar /</span> Alım Satım </h4>
                ...
                <div class="col-xl">
                  <div class="card mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center">
                      <h5 class="mb-0">Alım Satım Bilgileri Ekle</h5>
                      <small class="text-muted float-end">Alım Satım</small>
                    </div>
                    <div class="card-body">
                      
                      <form action="{{route('alimsatimekle')}}" method="POST" enctype="multipart/form-data">

                        @csrf
                        
                        <div class="mb-3">
                          <label class="form-label" >Satıcı İsmi</label>
                          <div class="input-group input-group-merge">
                            <textarea style="width: 100%" name="satici_ismi" cols="30" rows="2"></textarea>
                          </div>
                        </div>
                        ...
                        <div class="mb-3">
                          ...
                          <div class="input-group input-group-merge">
                            <input type="date" name="ilan_tarihi">
                          </div>
                        </div>
                        ...
                        <div class="mb-3">
                          ...
                          <div class="input-group input-group-merge">
                            <textarea style="width: 100%" name="urun_basligi" cols="30" rows="3"></textarea>
                          </div>
                        </div> 
                ...
                <div class="col-xl">
                  ...
                  <div class="card mb-4">
                    ...
                    <div class="card-header d-flex justify-content-between align-items-center">
                      ...
                      <div class="input-group input-group-merge">
                        <textarea style="width: 100%" name="urun_aciklamasi" cols="30" rows="5"></textarea>
                      </div>
                    </div>
                    
                    <div class="card-header d-flex justify-content-between align-items-center">
                      <h5 class="mb-0">Ürün Görseli</h5>
                      <small class="text-muted float-end">Ürün Fotoğrafı</small>
                    </div>
                    <div class="card-body">
                      <form>
                        ...
                        <div class="div_design">
                          ...
                          <input type="file" name="urun_gorseli" required="">
                        </div>
                        
                        
                        <button style="margin-top: 5%;" class="btn btn-primary">Ürünü Ekle</button>
